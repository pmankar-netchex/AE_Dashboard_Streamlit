...
S1_COL_K = SOQLEntry(
    ...
    section="Pipeline & Quota",
    description="(period) Number of Net New opportunities the AE is split-credited on that were created in the selected period.",
...
S1_COL_L = SOQLEntry(
    ...
    section="Pipeline & Quota",
    description="(period) Total Net New pipeline dollars (split-credited) from opportunities created in the selected period.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S1_COL_M = SOQLEntry(
    ...
    section="Pipeline & Quota",
    description="(period) Total Net New closed-won revenue (split-credited) with a Close Date in the selected period.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S1_COL_N = SOQLEntry(
    ...
    section="Pipeline & Quota",
    description="(period) Total Net New closed-lost revenue (split-credited) with a Close Date in the selected period.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S2_COL_O = SOQLEntry(
    ...
    description="(period) Number of distinct prospect contacts or leads emailed by the AE (excludes AM/SDR activity).",
...
S2_COL_P = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Number of distinct prospect contacts or leads the AE called on outbound calls (excludes AM/SDR activity).",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S2_COL_Q = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Number of distinct prospect contacts or leads where the AE left a voicemail on an outbound call.",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S2_COL_R = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Number of distinct accounts where the AE conducted an attended foot-canvass prospect meeting.",
...
S2_COL_S = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Number of distinct accounts where the AE held an attended Net New prospect meeting.",
    aggregation="COUNT_DISTINCT(WhatId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhatId) total
...
S3_COL_T = SOQLEntry(
    ...
    description="(period) Number of distinct contacts or leads emailed by the SDR(s) assigned to support this AE.",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S3_COL_U = SOQLEntry(
    ...
    section="SDR Activity",
    description="(period) Number of distinct contacts or leads called on outbound calls by the SDR(s) assigned to support this AE.",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S3_COL_V = SOQLEntry(
    ...
    section="SDR Activity",
    description="(period) Number of Net New prospect meetings scheduled by this AE's SDR(s).",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S3_COL_W = SOQLEntry(
    ...
    section="SDR Activity",
    description="(period) Number of attended Net New prospect meetings that were created by this AE's SDR(s).",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S4_COL_X = SOQLEntry(
    ...
    description="(period) Number of distinct channel-partner contacts emailed by the AE.",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S4_COL_Y = SOQLEntry(
    ...
    section="Channel Partners",
    description="(period) Number of distinct channel-partner contacts the AE called on outbound calls.",
    aggregation="COUNT_DISTINCT(WhoId)",
    time_filter=True,
    template="""
SELECT COUNT_DISTINCT(WhoId) total
...
S4_COL_Z = SOQLEntry(
    ...
    section="Channel Partners",
    description="(period) Number of scheduled channel-partner meetings owned by the AE.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S4_COL_AA = SOQLEntry(
    ...
    section="Channel Partners",
    description="(period) Number of channel-partner meetings attended (held) by the AE.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S6_COL_AE = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Number of Net New opportunities self-generated by the AE (the AE is both creator and split-credited).",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S6_COL_AF = SOQLEntry(
    ...
    section="Self-Gen Pipeline Creation",
    description="(period) Pipeline dollars (split-credited) from Net New opportunities self-generated by the AE.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S6_COL_AG = SOQLEntry(
    ...
    section="SDR Activity",
    description="(period) Number of Net New opportunities created by this AE's SDR where the AE is split-credited.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S6_COL_AH = SOQLEntry(
    ...
    section="SDR Activity",
    description="(period) Pipeline dollars (split-credited) from Net New opportunities created by this AE's assigned SDR.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S6_COL_AI = SOQLEntry(
    ...
    section="Channel Partners",
    description="(period) Number of Net New opportunities sourced from channel partners where the AE is split-credited. Edit the SOQL to match your org's lead-source values.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S6_COL_AJ = SOQLEntry(
    ...
    section="Channel Partners",
    description="(period) Pipeline dollars (split-credited) from Net New opportunities sourced from channel partners. Edit the SOQL to match your org's lead-source values.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S6_COL_AK = SOQLEntry(
    ...
    section="Marketing",
    description="(period) Number of open Net New opportunities (Revenue split) attributed to the Marketing source category.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S6_COL_AL = SOQLEntry(
    ...
    section="Marketing",
    description="(period) Open pipeline dollars (Revenue split) from Net New opportunities attributed to the Marketing source category.",
    aggregation="SUM(SplitAmount)",
    time_filter=True,
    template="""
SELECT SUM(SplitAmount) total
...
S5_COL_AB = SOQLEntry(
    ...
    section="Marketing",
    description="(period) Number of Net New prospect meetings sourced from marketing events such as conferences.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S5_COL_AC = SOQLEntry(
    ...
    section="Marketing",
    description="(period) Number of Net New prospect meetings sourced from inbound hand-raisers.",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
...
S5_COL_AD = SOQLEntry(
    ...
    section="Marketing",
    description="(period) Number of Net New prospect meetings sourced from other marketing channels (webinars or content).",
    aggregation="COUNT(Id)",
    time_filter=True,
    template="""
SELECT COUNT(Id) total
